...
```{r}
m1_lm <- lm(mean_correct ~ stimuli - 1, 
...
## Warning: "In matrix(value, n, p) : data length [8] is not a sub-multiple or multiple of the number of columns [6]"
```
