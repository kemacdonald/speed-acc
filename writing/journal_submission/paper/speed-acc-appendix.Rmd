...
E1: 
- RT: stan_glmer(log_rt ~ stimuli + scale(Months) + (1 | Sub.Num) + (1 | clean_target_img), 
- ACC: stan_glmer(correct ~ stimuli + scale(Months) + (1 | Sub.Num) + (1 | clean_target_img), 
- EWMA: stan_glmer(guess_num ~ stimuli + scale(months) + (1|subid) + (1|clean_target_img),
- HDDM: stan_lm(param_est ~ stimuli)
...
# Full output for analysis models in Experiment 1
...
# Full output for analysis models in Experiment 2
