...
\hypersetup{unicode=true,
            pdftitle={Children seek visual information during signed and spoken language comprehension},
...
\def\footnote{\protect\rmarkdownfootnote}
  ...
  \title{Children seek visual information during signed and spoken language
comprehension}
...
It is important to point out the correspondence between the reported
...
Finally, we chose not to collect our planned sample size (42) for each
...
These studies also also highlight the value of using both observational
and experimental approaches. In Experiment 1, we compared language
comprehension across populations of children who had very different
language experiences (signed vs.~spoken) to generate a novel explanation
