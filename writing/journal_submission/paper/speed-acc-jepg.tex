...
utterance (M. C. MacDonald \& Seidenberg, 2006; McClelland \& Elman,
1986). Under this more interactive account, listeners comprehend words
by partially activating several candidates that are consistent with
...
effect}) (J. MacDonald \& McGurk, 1978). Other research in
...
comprehension. The incoming linguistic signal is ephemeral, however, and
...
accounts of eye movements in everyday tasks (M. Hayhoe \& Ballard,
2005), and language perception as a process of multisensory cue
integration (Vigliocco, Perniss, \& Vinson, 2014). In the following
sections, we briefly review each of these literatures to motivate our
explanation of information-seeking eye movements in grounded signed and
...
fixations are driven by task goals (M. Hayhoe \& Ballard, 2005).
...
respect to some goal. For example, M. Hayhoe and Ballard (2005) review
...
learn to deploy efficient gaze patterns over the course of becoming more
...
partner should be considered as an input to children's language
comprehension. Finally, this work highlights the importance of studying
comprehension within face-to-face communication, where listeners can
choose to look at their social partners to gather language-releveant
information.
