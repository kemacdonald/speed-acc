...
We predicted that processing speech in a noisy context would make participants less likely to shift before collecting sufficient information, indexed by a lower proportion of shifts flagged as random in the EWMA analysis. We also predicted that both children and adults would adapt their gaze to gather additional visual information from the speaker in the noisier auditory environment. Finally, we tested whether children would show a greater reliance on visual information in the noisy context since their word-object representations are less-developed as compared to adults.
