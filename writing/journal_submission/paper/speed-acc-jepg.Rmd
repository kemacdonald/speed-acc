...
Table 1 contains details about the age distributions and sample sizes for children in all four studies. After excluding trials for inattention or parental interfence, children contributed on average `r printnum(ms_good_trials$m_good_trials)` trials to the analysis (min = `r printnum(ms_good_trials$min, digits = 0)`, max = `r printnum(ms_good_trials$max, digits = 0)`). 
