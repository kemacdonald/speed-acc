...
Across both experiments, the critical behavioral prediction is that listeners will adapt the timing of their eye movements to facilitate langauge processing. We hypothesized that as fixations to the source of language -- either a signer or a speaker -- provide higher value visual information, listeners should prioritize looking to their social partner. Concretely, in both sign langauge (Experiment 1) and in a noisy auditory environment (Experiment 2), looks to the language source should be more useful, and thus listeners would be (a) slower to shift gaze away from the language source, which in turn would lead to (b) more consistent shifts to named objects and (c) fewer early, nonlanguage-driven eye movements to the rest of the visual world.
