...
d_ewma_gaze <- gaze_ewma_files %>% purrr::map_df(read_ewma, path = ewma_path) 
```
...
posteriors <- list(ewma_cuts_noise = samples_ewma_cuts_noise,
...
saveRDS(posteriors, file = here::here(write_path,"speed-acc-gaze-posterior-samples.rds"))
