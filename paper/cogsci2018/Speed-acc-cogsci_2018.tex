...
the HDI such that 95\% of the credible values are greater than the null,
...
(\(\beta_{noise}\) = 11\%, {[}7\%, 17\%{]}). Within the child sample,
older children generated fewer random, early shifts (\(M_{age}\) =
-0.21, {[}-0.34, -0.08{]}). There was no eivdence of an interaction
