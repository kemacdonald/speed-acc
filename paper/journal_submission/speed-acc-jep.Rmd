---
title             : "An information-seeking account of children's eye movements during grounded language comprehension"
...
grid::grid.raster(png::readPNG(here::here("paper/journal_submission/figs/stimuli_info.png")))
```
...
```{r read trio data}
df_trio <- read_csv(here::here(data_path, "speed-acc-child-trio-fst-shift.csv")) 
...
d.asl <- read_csv(here::here(data_path, "speed-acc-child-trio-fst-shift.csv"))
```
...
png::readPNG(here::here("paper/journal_submission/figs/noise_behav_results.png")) %>% 
  grid::grid.raster()
```
