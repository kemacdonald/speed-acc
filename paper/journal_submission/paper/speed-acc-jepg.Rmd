...
knitr::opts_chunk$set(fig.pos = '!t', fig.width = 4, fig.asp=0.618, out.width = "85%", 
...
knitr::include_graphics(here::here(image_path, "trio_stimuli.png"), dpi = 108)
```
...
knitr::include_graphics(here::here(image_path, "fig1_trio_behav.png"), dpi = 108)
```
...
knitr::include_graphics(here::here(image_path, "fig2_trio_models.png"), dpi = 108)
```
...
```{r noise-model-plots, fig.env='figure', fig.cap = "Results for the model-based analyses for Experiment 3. The majority of plotting conventions are the same as Figure 3. In Panel C, linetype and alpha value represent age group: children vs. adults."}
knitr::include_graphics(here::here(image_path, "fig6_noise_models.png"), dpi = 108)
```
