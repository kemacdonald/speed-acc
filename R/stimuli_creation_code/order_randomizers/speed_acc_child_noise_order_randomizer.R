####### Randomize orders for child noise experiment
library(tidyverse)
...
write_csv(order_results, "../../data/trial_info/speed_acc_child_noise_orders.csv")
...
write_csv(order_results_added, "../../../data/0b_trial_information/speed_acc_child_noise_orders_added.csv")