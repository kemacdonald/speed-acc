#### This script takes in raw .xml files that have trial level information for the speed_acc_child_noise_experiment
...
read.path <- "../../data/0b_trial_information/speed_acc_child_noise_xml/"
...
log_file_path <- "../../data/0b_trial_information/speed_acc_child_noise_xml/"
stim.log <- list()
...
####### Write to .csv
write_csv(trial_info_df, path = "../../data/trial_info/speed-acc-child-noise-trial-info.csv")
