...
trio_ps <- read_csv_fun(path = "../../data/trial_info/", file_name = "trio_prescreening_info.csv") 
...
```{r}
speed_acc_df_final <- bind_rows(sol_df_final, trio_face_final, trio_26_final, trio_36_final, 
