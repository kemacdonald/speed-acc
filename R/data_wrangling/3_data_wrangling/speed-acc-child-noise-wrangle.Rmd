...
d.timecourse <- d %>%
  ...
  select(subid, subid_short, t.stim, gaze_condition, noise_condition, target_image,
         tr.num, noun_onset_sec, gaze_target:shift_accuracy, shift_accuracy_clean, shift_start_location,
...
write_csv(d.fs, path = paste0(write.path.fst, 
