...
KM note: I'm not sure how we should handle shifts that happen before noun onset? My thought is to feed them into the EWMA, but not into the summary analyses and the DDM fits.
