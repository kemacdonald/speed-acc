...
```{r}
df_trio_kid <- read_csv(here::here(read.path, "speed-acc-child-trio-fst-shift.csv"))
...
write_csv(ss.ewma.trio, here::here(wr.path, "speed_acc_kids_trio_ewma_results.csv"))
write_csv(ss.ewma.gaze.kid, here::here(wr.path, "speed_acc_kids_gaze_ewma_results.csv"))
write_csv(ss.ewma.noise.kid, here::here(wr.path, "speed_acc_kids_noise_ewma_results.csv"))
write_csv(ss.ewma.text.adult, here::here(wr.path, "speed_acc_adult_text_ewma_results.csv"))
write_csv(ss.ewma.ng.adult, here::here(wr.path, "speed_acc_adult_ng_ewma_results.csv"))
```
