...
```{r}
prediction <- c("speed accuracy tradeoff", "speed accuracy tradeoff", "language cue dominates", "language cue dominates")
condition <- c("gaze", "no_gaze", "gaze", "no_gaze")
reaction_time <- c(0.9, 0.6, 0.6, 0.6)
accuracy <- c(0.9, 0.55, 0.55, 0.55)
