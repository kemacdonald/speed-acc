...
d.words.length <- read_csv("../../data/trial_info/speed-acc-adult-trial-timing-info.csv")
d.signs.length <- read_csv("../../data/trial_info/target_sign_lengths_all.csv")
```
...
e1_control_chart <- ms.ewma.e1 %>% 
  ...
  #geom_vline(aes(xintercept = m), linetype = 1, color = "darkblue", size = 0.7,
   #          data = sign_len_plot_info) +
...
```{r e2_plot_print, fig.env = "figure", fig.pos = "t",fig.width=3, fig.height=2.8, fig.align='center', fig.cap = "Behavioral results from E2. All plotting conventions are the same as in Figure 2."}
...
We are grateful to the families who participated in this research. This work was supported by an NSF GRFP to KM and an NIDCD grant to Anne Fernald and David Corina (DC012505).
