...
```{r read e1 data}
df_e1 <- read.csv("../../data/3_final_merged_data/speed-acc-participant-level-df.csv", 
...
d.words.length <- read_csv("../../data/0b_trial_information/speed-acc-adult-trial-timing-info.csv")
